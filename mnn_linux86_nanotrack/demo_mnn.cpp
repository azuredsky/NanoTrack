...
int main(int argc, char** argv)
{
    ...
    // Get model path.
    std::string backbone_model = "./models/nanotrack_backbone_sim.mnn";
    std::string head_model = "./models/nanotrack_head_sim.mnn"; //

    // Get video path                    
    //const char* video_path = argv[1];
    const char* video_path = "/home/sky/work/mmsd/data/chn_huiyi_220927/data/mp4/VID_20220926_043203.mp4";//"./data/videos/girl_dance.mp4";
